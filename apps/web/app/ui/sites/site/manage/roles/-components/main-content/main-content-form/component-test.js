...
module('Integration | Component | sites/site/manage/roles/-components/main-content/main-content-form', (hooks) => {
  ...
  test('should fire an external action when inputting search field', async function (assert) {
    ...
    await render(hbs`
      {{sites/site/manage/roles/-components/main-content/main-content-form
