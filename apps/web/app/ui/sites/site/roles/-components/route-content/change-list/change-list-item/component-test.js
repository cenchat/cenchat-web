...
module('Integration | Component | sites/site/roles/-components/route-content/change-list/change-list-item', function (hooks) {
  ...
  test('should show user', async function (assert) {
    ...
    // Act
    await render(hbs`
      {{sites/site/roles/-components/route-content/change-list/change-list-item
        --user=user
