...
module('Integration | Component | notifications/-components/notification-list/notification-list-comment-tag-item', (hooks) => {
  ...
  test('should show notification info', async (assert) => {
    ...
    // Act
    await render(hbs`
      {{notifications/-components/notification-list/notification-list-comment-tag-item --notification=notification}}
    `);
