...
module('Integration | Component | profile/settings/-components/security-settings/security-settings-delete-account', function (hooks) {
  ...
  test('should show confirm delete content when clicking delete', async function (assert) {
    ...
    // Arrange
    await render(hbs`
      {{profile/settings/-components/security-settings/security-settings-delete-account
