...
module('Integration | Component | sites/site/index/roles/-components/main-content/main-content-change-list', (hooks) => {
  ...
  test('should show <ChangeListItem /> for every admin addition', async function (assert) {
    ...
    const spy = spyComponent(this, 'sites/site/index/roles/-components/main-content/main-content-change-list/change-list-item');

    // Act
    await render(hbs`
      {{sites/site/index/roles/-components/main-content/main-content-change-list
