...
module('Integration | Component | sites/site/index/-components/main-content/main-content-page-collection/page-collection-item', (hooks) => {
  ...
  test('should show page info', async (assert) => {
    ...
    // Act
    await render(hbs`
      {{sites/site/index/-components/main-content/main-content-page-collection/page-collection-item
          --router=router
          --page=page}}
    `);
