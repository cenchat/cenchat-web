...
module('Integration | Component | sites/site/index/roles/-components/main-content/main-content-change-list/change-list-item', (hooks) => {
  ...
  test('should show user', async (assert) => {
    ...
    // Act
    await render(hbs`
      {{sites/site/index/roles/-components/main-content/main-content-change-list/change-list-item
          --user=user
