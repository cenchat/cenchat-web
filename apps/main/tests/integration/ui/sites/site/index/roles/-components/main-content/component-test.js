...
module('Integration | Component | sites/site/index/roles/-components/main-content', (hooks) => {
  ...
  test('should show <MainContentForm />', async function (assert) {
    ...
    // Arrange
    const spy = spyComponent(this, 'sites/site/index/roles/-components/main-content/main-content-form');

    // Act
    await render(hbs`
      {{sites/site/index/roles/-components/main-content
  ...
  test('should show <MainContentChangeList /> when there are role changes', async function (assert) {
    ...
    // Arrange
    const spy = spyComponent(this, 'sites/site/index/roles/-components/main-content/main-content-change-list');
  ...
  test('should show <MainContentUserList /> for users with role when available', async function (assert) {
    ...
    // Arrange
    const spy = spyComponent(this, 'sites/site/index/roles/-components/main-content/main-content-user-list');
    const user = await this.store.findRecord('user', 'user_b');
