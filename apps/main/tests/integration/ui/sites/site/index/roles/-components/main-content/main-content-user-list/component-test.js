...
module('Integration | Component | sites/site/index/roles/-components/main-content/main-content-user-list', (hooks) => {
  ...
  test('should show <UserListItem /> for every user', async function (assert) {
    ...
    // Arrange
    const spy = spyComponent(this, 'sites/site/index/roles/-components/main-content/main-content-user-list/user-list-item');

    // Act
    await render(hbs`
      {{sites/site/index/roles/-components/main-content/main-content-user-list
          --users=users
          --hasRole=hasRole
