...
module('Acceptance | sites/site/pages/page/explore/chat/messages', function (hooks) {
  ...
  test('should list messages', async function (assert) {
    ...
    // Act
    await visit('/sites/site_c/pages/page_a/explore/site_c__page_a__user_a/messages');
