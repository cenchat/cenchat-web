...
module('Unit | Route | sites/site/pages/page/explore/chat/messages', function (hooks) {
  ...
  test('should return chat messages as model', async function (assert) {
    ...
    // Arrange
    const route = this.owner.lookup('route:sites/site/pages/page/explore/chat/messages');

    sinon.stub(route, 'modelFor').withArgs('sites.site.pages.page.explore.chat').returns({
